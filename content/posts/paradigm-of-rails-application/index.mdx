...
date: 2020-03-25
description: Understanding the paradigm and the MVC design pattern behind a Rails application.
tags:
  - Technology
  - Ruby on Rails
---
...
View is the part responsible for whatever is seen on the browser. By default rails uses embedded Ruby (erb) for views. But we can change that, for example we can use **[React JS](/connecting-rails-with-react-js-using-js-routes)** as view part.
...
SO, This was pretty much all i wanted to share about rails workflow. I hope it will help you at least to some extend. Got a question hit me on [Twitter](https://twitter.com/codeSwastik) DM.
